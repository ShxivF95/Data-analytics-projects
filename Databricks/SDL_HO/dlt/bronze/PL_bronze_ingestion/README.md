...
This folder defines all source code for the 'bronze_ingestion.py' pipeline:
...
* Take a look at the sample under "sample_users_bronze_ingestion_py.py" to get familiar with the syntax.
